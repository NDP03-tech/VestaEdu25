	...
	return (
		<div className="react-breadcrumbs single-page-breadcrumbs">
			<div className="breadcrumbs-wrap">
				{/* Sửa lỗi require() - Dùng URL trực tiếp */}
				<img className="desktop d-none d-md-block img-fluid" src={courseBannerImg} alt={courseTitle} />
<img className="mobile d-block d-md-none img-fluid" src={courseBannerImg} alt={courseTitle} style={{ width: "100%", height: "auto", maxHeight: "300px", objectFit: "cover" }}  />
					...
					<div className="container">
						<div className="breadcrumbs-text">
							...
							<ul className="user-section">
								<li className="user">
									{/* Sửa lỗi require() - Dùng URL trực tiếp */}
									<span><img src={courseAuthorImg} alt="user" /></span>
