                ...
                <div className="footer-widget footer-widget-1">
                  ...
                  <ul className="footer-address">
                    <li>
                      ...
                      <a href="tel:+(402)76244183"> (+84) 83877 99 88 </a>
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <a href=" info@vestaedu.online"> info@vestaedu.online </a>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="footer-widget footer-widget-2">
                  <div className="footer-menu">
                    <ul>
                      ...
                      <li>
                        <Link to="/instructor">Career</Link>
                      </li>
              ...
              <div className="col-lg-3 md-mb-30">
                <div className="footer-widget footer-widget-3">
                  <div className="footer-menu">
                    <ul>
                      <li>
                        <Link to="/instructor">Partners</Link>
                      </li>
                      <li>
        ...
        <div className="copyright">
          <div className="container">
            <div className="react-copy-left">
              © 2025 <Link to="">VESTA ACADEMY</Link> All Rights Reserved
            </div>
