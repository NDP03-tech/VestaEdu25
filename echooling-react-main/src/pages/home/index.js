...
const HomePage = () => {
  ...
  const handleRegisterClick = () => {
    const registrationUrl =
      "https://docs.google.com/forms/d/15ZawiHnB5qJTQZw-N-0-C8ChmHL7y6ELEJ4H7jzhGMM/viewform?edit_requested=true";
          ...
          >
            ...
            <div style={styles.contentWrapper}>
              ...
              <div style={styles.leftSection}>
                <h1 style={styles.title}>Đăng Ký Ngay Để Nhận Ưu Đãi!</h1>
              ...
              <div style={styles.rightSection}>
                ...
                <h3 style={styles.sectionTitle}>Những khóa học tiêu biểu:</h3>
