...
import { Tabs, Table, message, Card, Input, Button, Space, Tag } from "antd";
import {
  BookOutlined,
  TeamOutlined,
  SearchOutlined,
    ...
    },
    {
      ...
      render: (text) => (
        <span>
          ...
          {isRecent(text) && <Tag color="green">New</Tag>}
        </span>
      ),
    },
  ];
              ...
              <div style={{ padding: 16 }}>
                <Space style={{ marginBottom: 8, float: "right" }}>
                  <Button
                    ...
                    type="default"
                    onClick={() => exportPDF(eventRegistrations, "Event")}
                  >
                    Export PDF
                  </Button>
                </Space>
              ...
              <div style={{ padding: 16 }}>
                <Space style={{ marginBottom: 8, float: "right" }}>
                  <Button
                    icon={<FilePdfOutlined />}
                    type="default"
                    onClick={() => exportPDF(courseRegistrations, "Course")}
                  >
                    Export PDF
                  </Button>
                </Space>
